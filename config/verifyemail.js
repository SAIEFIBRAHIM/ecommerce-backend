...
const verifyEmail = async (to, uname, content) => {
  try {
  ...
  <style type="text/css">
    ...
    <tbody>
      <tr>
        <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Thanks for signing up, ${uname}&nbsp;</span></div><div></div></div></td>
      </tr>
    </tbody>
